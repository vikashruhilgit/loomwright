...
#
# Config resolution (vault):  $AI_AGENT_MANAGER_OBSIDIAN_VAULT > .supervisor/obsidian-config.json .vault
# Config resolution (slug):   $AI_AGENT_MANAGER_OBSIDIAN_SLUG  > .supervisor/obsidian-config.json .slug > basename($GITROOT)
#
...
VAULT="${AI_AGENT_MANAGER_OBSIDIAN_VAULT:-}"
...
To opt in, do ONE of:
  1. Set an environment variable to your vault path:
       export AI_AGENT_MANAGER_OBSIDIAN_VAULT="$HOME/Obsidian/MyVault"
...
SLUG="${AI_AGENT_MANAGER_OBSIDIAN_SLUG:-}"
