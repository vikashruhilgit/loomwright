...
WORKER_RESULT:
  ...
  memory_candidates: string[]          # optional — additive, does NOT bump schema_version (stays 2, same precedent as the v2 outputs_verified optional-add); absent by default. Durable, reusable structural facts about the codebase proposed for project memory; NEVER secrets/PII/tokens. Workers PROPOSE only — they never write memory (worktree-write ban / red-team F1); promotion is human-gated.
