...
- Local plugin file `ai-agent-manager-plugin/hooks/hooks.json` — read 2026-05-10 to confirm currently-used hook event types (`SubagentStop`, `Stop`, `TaskCompleted`, `WorktreeCreate`, `StopFailure`)
