...
**Prerequisite:** the BASE_BRANCH end-to-end fix from commit `14a9c40` is on the branch under test (verify with `grep -n 'BASE_BRANCH="${BASE_BRANCH:-main}"' ai-agent-manager-plugin/agents/supervisor.md` — should match Phase 1 step 4, line ~209).
