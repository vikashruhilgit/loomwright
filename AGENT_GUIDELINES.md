...
tools: Read, Write, Edit, Bash, ...      # Byte-identical superset allowlist across all 14 prefix-bearing agent prompts (12 loomwright + 2 selvedge, since the QA pair moved) (see below); per-agent restriction lives in disallowedTools
