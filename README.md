...
3. Skills are in `ai-agent-manager-plugin/skills/` (53 skills, versioned with SKILLS_INDEX.md)
...
3. Verify with `/skills` — should show all 53 skills under "Plugin skills". Use `/agent-help` to confirm all 16 user-facing commands are registered.
