...
2. Commands are in `ai-agent-manager-plugin/commands/` (20 commands)
3. Skills are in `ai-agent-manager-plugin/skills/` (56 skills, versioned with SKILLS_INDEX.md)
...
3. Verify with `/skills` — should show all 56 skills under "Plugin skills". Use `/agent-help` to confirm all 20 slash commands are registered.
