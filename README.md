...
2. Commands are in `ai-agent-manager-plugin/commands/` (17 commands)
3. Skills are in `ai-agent-manager-plugin/skills/` (52 skills, versioned with SKILLS_INDEX.md)
...
3. Verify with `/skills` — should show all 52 skills under "Plugin skills". Use `/agent-help` to confirm all 16 user-facing commands are registered.
