...
- **`scope fidelity` prints TWO figures, and the second one is the honest one.** The first is over
  ...
  corpus 98% (54 of 55) checkable against 73% (54 of 74) overall. The 19-finding difference is
...
--- target class (AC14) ---
  ...
  share of all findings:      107/225 (48%)
