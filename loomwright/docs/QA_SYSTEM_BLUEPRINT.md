...
The QA system adds two agents (QA Strategist + QA Executor) to the loomwright plugin. They implement autonomous QA automation through a bounded debate loop, risk-based test strategy, and 4-phase discovery.
