...
(`loomwright/scripts/brain-baseline-eval.sh`). See
`loomwright/docs/SPIKES/BRAIN_INTEGRATION_EVOLUTION.md` §"Phase 0 — Baseline eval
...
**Location:** this directory (`loomwright/scripts/brain-baseline-corpus/`, a sibling of
