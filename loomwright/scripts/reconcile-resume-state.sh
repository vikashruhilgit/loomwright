...
#
#   Commit convention is mandated, not guessed: skills/async-orchestration/SKILL.md:568
...
#
#   1. `subtask: {id} — {title}`   worker commit      (async-orchestration/SKILL.md:568
#                                                     [pins: `subtask: {subtask_a} — {title}`])
#   2. `merge: {id} {title}`       mandated merge     (async-orchestration/SKILL.md:575-577
