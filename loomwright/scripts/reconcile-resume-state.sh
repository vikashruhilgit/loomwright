...
#
#   Commit convention is mandated, not guessed: skills/async-orchestration/SKILL.md:555
...
#
#   1. `subtask: {id} — {title}`   worker commit      (async-orchestration/SKILL.md:555
#                                                     [pins: `subtask: {subtask_a} — {title}`])
#   2. `merge: {id} {title}`       mandated merge     (async-orchestration/SKILL.md:562-564
