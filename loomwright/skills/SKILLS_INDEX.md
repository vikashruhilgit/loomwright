...
|------------|-----------|-----------------|------------|---------|--------------|
| Supervisor Readiness | `supervisor-readiness/` | Launch Pad (preload) | ~800 | 1.6.0 | 2026-09-26 |
...
| Automate Loop | `automate-loop/` | `/automate` (slash command, reference) | ~3,200 | 1.7.0 | 2026-09-26 |
