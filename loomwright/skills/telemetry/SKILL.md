...
Full design: `loomwright/docs/TELEMETRY.md`.

---

## When to Use

- A project has installed the loomwright plugin and wants to
...
3. From the next qualifying agent run, the `SubagentStop` hook invokes
   ...
   `loomwright/...` paths — they only work in the
...
- `loomwright/docs/TELEMETRY.md` — full design,
