...
└── loomwright/                 # The nested plugin
    ├── .claude-plugin/
    │   └── plugin.json                      # Plugin manifest (v15.5.0)
    ...
    ├── skills/                              # 59 focused skill modules
