...
└── loomwright/                 # The nested plugin
    ...
    │   ├── code-reviewer.md, red-team-reviewer.md, review-pr.md, qa-strategist.md, qa-executor.md, verify.md
    ...
    ├── hooks/
    │   └── hooks.json                       # 43 quality gate hooks (centralized)
...
43 hooks centralized in `hooks.json` validate agent output and surface notifications:
