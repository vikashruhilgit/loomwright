...
└── loomwright/                 # The nested plugin
    ...
    ├── hooks/
    │   └── hooks.json                       # 23 quality gate hooks (centralized)
