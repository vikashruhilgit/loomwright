...
└── ai-agent-manager-plugin/                 # The nested plugin
    ├── .claude-plugin/
    │   └── plugin.json                      # Plugin manifest (v14.48.0)
