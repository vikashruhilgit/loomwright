...
└── ai-agent-manager-plugin/                 # The nested plugin
    ├── .claude-plugin/
    │   └── plugin.json                      # Plugin manifest (v14.25.1)
