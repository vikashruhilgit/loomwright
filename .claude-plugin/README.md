...
└── loomwright/                 # The nested plugin
    ├── .claude-plugin/
    │   └── plugin.json                      # Plugin manifest (v15.14.0)
    ...
    ├── hooks/
    │   └── hooks.json                       # 22 quality gate hooks (centralized)
...
22 hooks centralized in `hooks.json` validate agent output and surface notifications:
