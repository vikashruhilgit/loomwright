...
└── loomwright/                 # The nested plugin
    ...
    ├── hooks/
    │   └── hooks.json                       # 25 quality gate hooks (centralized)
...
25 hooks centralized in `hooks.json` validate agent output and surface notifications:
