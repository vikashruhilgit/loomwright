...
└── loomwright/                 # The nested plugin
    ├── .claude-plugin/
    │   └── plugin.json                      # Plugin manifest (v15.4.0)
    ...
    ├── hooks/
    │   └── hooks.json                       # 21 quality gate hooks (centralized)
...
21 hooks centralized in `hooks.json` validate agent output and surface notifications:
